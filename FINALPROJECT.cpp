...
void Add() {
    ...
    for (int i = total; i < total + choice && i < maxStudents; i++) {
        ...
        cout << "Course: ";
        cin >> s1[i].course;
    } cout<<"Student Added successfully!"<<endl;system("pause");
    total += choice;
...
void Search() {
    ...
    for (int i = 0; i < total; i++) {
        if (s1[i].rollNo == rollNo) {
            ...
            cout << "Course: " << s1[i].course << endl; system("pause"); 
            return; 
      }
    }
    setColor(4);
...
void Delete() {
    ...
    for (int i = 0; i < total; i++) {
        if (s1[i].rollNo == rollNo) {
            ...
            total--;
            setColor(2);
            cout << "Record deleted successfully!" << endl; system("pause");
            return;
        }
    } 
    setColor(4);
...
void Update() {
    ...
    for (int i = 0; i < total; i++) {
        if (students[i].rollNo == rollNo) {
            ...
            cin >> s1[i].course;
            setColor(2);
            cout << "Details updated successfully!" << endl;system("pause");
            return;
        }
    }
    setColor(4);
            ...
            switch (choice) {
                ...
                case 4: {
                    ...
                    if (historyIndex == -1) {  setColor(4);
                        ...
                        cout << "Updating Enrollment  for Roll No: " << rollNo << '\n';
                        cout << "Enter new course: ";
                        cin.ignore();
